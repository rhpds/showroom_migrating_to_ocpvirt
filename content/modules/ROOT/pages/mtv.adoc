...
. Navigate to *Virtualization* -> *VirtualMachines* and ensure the migrated VMs are there - you may need to select the *Project* `vmexamples` from the *Project* drop-down.
+
